...
export class CreateInitialTables1769019061687 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_da95bf31b793c830c4fc30b141" ON "seats" ("session_id", "seat_number") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_58bd6eba2b40f130719538c813" ON "sales" ("user_id", "created_at") `);
        await queryRunner.query(`ALTER TABLE "seats" ADD CONSTRAINT "FK_678c034ca5e301023893d721398" FOREIGN KEY ("session_id") REFERENCES "sessions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "reservations" ADD CONSTRAINT "FK_b069fceb9fa6d2959cd58ba5dfc" FOREIGN KEY ("session_id") REFERENCES "sessions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "sales" ADD CONSTRAINT "FK_b326b11849693b64c1f87284384" FOREIGN KEY ("session_id") REFERENCES "sessions"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sales" DROP CONSTRAINT "FK_b326b11849693b64c1f87284384"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_58bd6eba2b40f130719538c813"`);
        await queryRunner.query(`DROP TABLE "sales"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_8a3b7f9fd855a1205b97c2453e"`);
        await queryRunner.query(`DROP TABLE "reservations"`);
        await queryRunner.query(`DROP TYPE "public"."reservations_status_enum"`);
        await queryRunner.query(`DROP TABLE "sessions"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_da95bf31b793c830c4fc30b141"`);
